...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#aa151b] text-white shadow-lg backdrop-blur-md pt-[env(safe-area-inset-top)] pattern-seigaiha">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2 flex flex-col sm:flex-row items-center justify-between gap-2">
        ...
        <div className="flex items-center justify-between w-full sm:w-auto gap-3">
          ...
          <div className="flex sm:hidden items-center gap-2">
            <div className="flex items-center gap-1 bg-[#7a1015] px-2 py-1 rounded-full text-[11px] font-bold font-mono">
        ...
        <nav className="flex items-center gap-0.5 bg-[#7a1015] p-1 rounded-full border border-white/10 w-full sm:w-auto overflow-x-auto no-scrollbar justify-between sm:justify-center">
          {([
        ...
        <div className="hidden sm:flex items-center gap-3 shrink-0">
          <div className="flex items-center gap-1.5 bg-[#7a1015] px-2.5 py-1 rounded-full text-xs font-bold font-mono">
            <span className="text-red-200">最後更新</span>
